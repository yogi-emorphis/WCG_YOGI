/**
 * Tests for the Glowstar Diamond API Integration
 */
 var fs = require("fs");
...
const sunriseDiamonds = require('../../app/supplierAPIs/glowstar');

const should = chai.should();
chai.use(chaiHttp);

describe('Glowstar Diamond API Integration', function () {
  this.timeout(7000);
  let sunrise;
  ...
  it('the domain name should be online', done => {
    ping.promise.probe('glowstaronline.com')
      .then(res => {
