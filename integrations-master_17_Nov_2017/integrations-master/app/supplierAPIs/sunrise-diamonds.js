...
const mapSunriseFields = function (data) {
  ...
  const certiNo = data['Certi. No'];
  const image = `http://www.sunrisediamonds.com.hk/img/${certiNo}/PR.jpg`;
  let v360;
  let segoma;
...
const handleResponse = function (data, supplierId) {
  ...
  return APIHandlers.JSONObject(data, supplierId, mapSunriseFields, checkDiamond);
};
